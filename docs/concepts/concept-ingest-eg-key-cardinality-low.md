...
* [STRINGSET data type](https://docs.featurebase.com/docs/sql-guide/data/-types/data-type-stringset)
* [BULK INSERT statement](https://docs.featurebase.com/docs/sql-guide/statements//statement-insert-bulk)
* [SETCONTAINS function](https://docs.featurebase.com/docs/sql-guide/functions/function-setcontains)
* [SETCONTAINSALL function](https://docs.featurebase.com/docs/sql-guide/functions/function-setcontainsall)
* [SETCONTAINSANY function](https://docs.featurebase.com/docs/sql-guide/functions/function-setcontainsany)
