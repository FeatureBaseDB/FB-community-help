...
| ---------------- | --------------------------------------------------------------------------------------- |
| Boolean          | [BOOL](https://docs.featurebase.com/docs/sql-guide/data/-types/data-type-bool)                                       |
| Unsigned integer | [ID](https://docs.featurebase.com/docs/sql-guide/data/-types/data-type-id)                                           |
| Alphanumeric     | [String](https://docs.featurebase.com/docs/sql-guide/data/-types/data-type-string)                                   |
| Low cardinality  | [SET, SETQ](https://docs.featurebase.com/docs/sql-guide/data/-types/data-types-home/#low-cardinality-data-types) |
